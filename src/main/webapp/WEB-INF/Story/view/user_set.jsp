		...
		<div style="margin-left: 25%; margin-right: 25%;">	
			...
			<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/story/user_updateUPro">
				<div class="w3-card w3-round w3-white w3-padding">
					...
					<div class="w3-row w3-section">
					  <div class="w3-col w3-blue w3-round w3-center" style="width:100px;">배경</div>
					    <div class="w3-rest">
					...
					<div class="w3-row w3-section">
					  <div class="w3-col w3-blue w3-round w3-center" style="width:100px; margin-right: 3%;">사진</div>
					    <div class="w3-rest" >
					...
					<div class="w3-row w3-section">
					    <div class="w3-rest w3-right">
					      ...
					      <a class="w3-btn w3-red w3-round w3-padding" href="${pageContext.request.contextPath}/story/user_deleteUPro?email=${user.email}&pwd=${user.pwd}">삭제</a>
